...
class Arena(object):
    ...
    """
    def __init__(self, player1: Callable, player2: Callable, game: Game, display: Callable[..., Any] = lambda x: x) -> None:
        """
        Input:
    ...
    def playGames(self, num: int, pool: Pool, verbose: bool = False) -> Tuple[int, int, int]:
        """
